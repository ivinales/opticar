...
class ReservaController extends Controller
{
    ...
    public function reservasByTaller($id_taller,$mes){
        return ReservaResource::collection(Reserva::where('taller_id',$id_taller)->whereMonth('fecha', '=', $mes)->get());
    }
    ...
    public function store(Request $request)
    {
        ...
        if($reservado){
            ...
            $reserva->taller_id = $request->taller_id;
