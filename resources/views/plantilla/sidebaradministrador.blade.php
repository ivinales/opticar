        ...
        <ul class="nav">
           ...
           {{-- <li @click="menu=2" class="nav-item">
            ...
            <li @click="menu=21" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-users"></i> Vehiculos</a>
            </li>

            <li @click="menu=7" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-user"></i> Cuentas</a>
            </li>
            ...
            <li @click="menu=11" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-list"></i> Talleres</a>
            </li>

            <li @click="menu=12" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-list"></i> Asignacion</a>
            </li>
            {{--<li @click="menu=30" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-list"></i> Mensajes</a>
            </li>--}}
