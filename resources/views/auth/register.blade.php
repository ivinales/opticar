            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="num_documento" class="col-md-4 col-form-label text-md-right">{{ __('Rut') }}</label>
                        ...
                        <div class="form-group row mb-0 " >
                            <div class="col-md-6 offset-md-4" style="text-align: right">
                                <button onclick="window.location.href = '/login';" class="btn btn-danger">
                                    {{ __('Volver') }}
                                </button>
                            </div>
                            <div class="col-md-6 offset-md-4" style="text-align: left">
