            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                       ...
                       <h2>Historial Reparaciones</h2><br/>
...
<script>
    ...
    export default {
        ...
        methods:{
           ...
           listarCliente(page,buscar,criterio,rut){
               let me=this;

               var url= '/historialcliente?page=' + page + '&buscar='+ buscar + '&criterio='+criterio + '&rut='+rut;

               axios.get(url).then(function (response) {
                    // handle success
                    //console.log(response);
                    var respuesta = response.data;
                    me.arrayReparacion=respuesta.reparacion.data;
           ...
           abrirModal(id){
               ...
               var url= '/detallereparacion?&criterio='+id;
        ...
        mounted() {
            ...
            this.listarCliente(1,this.buscar,this.criterio,this.rut);
        }
    }
</script>
