                                ...
                                <tr v-for="cliente in arrayCliente" :key="cliente.id">
                                    ...
                                    <td>
                                        ...
                                        <template v-if="cliente.estado">
                                            <button type="button" class="btn btn-success btn-sm" @click="desactivarCliente(cliente.id)">
                                                <i class="fa fa-unlock fa-2x"></i> Activado
                                            </button>
                                        </template>

                                        <template v-else>
                                            <button type="button" class="btn btn-danger btn-sm" @click="activarCliente(cliente.id)">
